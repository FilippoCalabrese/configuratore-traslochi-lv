    ...
    <main class="flex-1 w-full px-4 pb-24 pt-6">
        <div class="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6">
            ...
            <aside class="w-full lg:w-[420px] space-y-4 lg:sticky lg:top-[120px]">
                <div class="bg-white/90 border border-gray-200 rounded-3xl shadow-[0_18px_40px_rgba(15,23,42,0.08)] p-6 space-y-6">
                    ...
                    <div class="space-y-2 text-sm">
                        <div class="flex items-start gap-3">
                            <svg class="icon-sm mt-0.5 text-gray-400 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                            <div class="flex-1">
                                <div class="text-xs font-semibold uppercase text-gray-500 mb-1">Nome cliente</div>
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex items-start gap-3">
                            <svg class="icon-sm mt-0.5 text-gray-400 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
                            <div class="flex-1">
                                <div class="text-xs font-semibold uppercase text-gray-500 mb-1">Indirizzo di carico</div>
                        ...
                        <div class="flex items-start gap-3">
                            <svg class="icon-sm mt-0.5 text-gray-400 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
                            <div class="flex-1">
                                <div class="text-xs font-semibold uppercase text-gray-500 mb-1">Indirizzo di scarico</div>
                    ...
                    <div class="space-y-4">
                        <div class="text-xs flex flex-col gap-2">
                            ...
                            <select
                                ...
                                class="select select-sm select-bordered rounded-2xl h-10"
                            >
                    ...
                    {{-- Dettaglio Costi --}}
                    <div class="rounded-2xl bg-gray-50 border border-dashed border-gray-300 px-4 py-3 text-xs">
                        <div class="flex items-center gap-2 text-gray-500 font-semibold uppercase mb-3">
